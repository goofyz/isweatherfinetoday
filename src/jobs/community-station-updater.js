...
export async function runCommunityStationUpdater() {
  console.log('Community.Station - start');
  ...
  for (const station of json) {
    ...
    if (!ws) {
      console.log(`ERROR: invalid weather station code: ${station.station}`);
      ...
      ws = ins;
      console.log(`createing Community Station ${station.station}`);
    }
  ...
  console.log('Community.Station - end');
}
